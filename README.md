...
```sh
curl -fsSL https://raw.githubusercontent.com/thekeoni1/Temur/v0.15.0/scripts/install.sh | sh
```

Piping to `sh` is a trust decision: [read the script
first](https://github.com/thekeoni1/Temur/blob/v0.15.0/scripts/install.sh) if
...
```sh
curl -fsSLO https://github.com/thekeoni1/Temur/releases/download/v0.15.0/temur-v0.15.0-x86_64-unknown-linux-musl
curl -fsSLO https://github.com/thekeoni1/Temur/releases/download/v0.15.0/SHA256SUMS
sha256sum -c --ignore-missing SHA256SUMS
install -m 755 temur-v0.15.0-x86_64-unknown-linux-musl ~/.local/bin/temur
```
