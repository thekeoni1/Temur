...
| Shipped bytes / peak RSS / warm cold-start | temur 7.5 MB / 37.1 MiB / 0.03 s (the v0.25.0 measurement; current sizes are in README's size sentence); codex 258 MB / 119.2 MiB / 0.23 s; opencode 184 MB / 842.9 MiB / 2.48 s | [section](#footprint) |
