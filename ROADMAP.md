...
- **Stringified scalars are rejected outright.** Models send `"false"`
  ...
  the 2026-08-15 pass, on two models: Llama-3.2-3B (five archived tasks)
  and Qwen2.5-Coder-1.5B (one). Only booleans and `u64` counts are hit,
