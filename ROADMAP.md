...
- **Usage accounting for thinking tokens (F11).** Gemini does not
  ...
  session total is currently a floor presented as a total.
- **Footer relabel (F2).**
